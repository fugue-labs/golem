...
func New(_ color.Color) *Styles {
	...
	s.Panel.HeaderActive = lipgloss.NewStyle().Foreground(fgStrong).Background(surface).Padding(0, 1).Bold(true)
	s.Panel.HeaderInactive = lipgloss.NewStyle().Foreground(fgHalf).Background(bgBase).Padding(0, 1)
	s.Panel.HeaderMeta = lipgloss.NewStyle().Foreground(fgHalf)
